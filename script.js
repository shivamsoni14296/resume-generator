...
function generatecv() {
  ...
  document.getElementById("tpin").innerHTML =
    document.getElementById("pincodfield").value;

  document.getElementById("tfb").innerHTML =
    document.getElementById("fbfield").value;
  document.getElementById("tlin").innerHTML =
    document.getElementById("linkedinfield").value;
  document.getElementById("tgit").innerHTML =
    document.getElementById("githubfield").value;

  document.getElementById("tob").innerHTML =
    document.getElementById("odjecctivefield").value;
